...
function createMockDetail(
  ...
  return {
    ...
    directDiscountYn: true,
    greetingMsg: "안녕하세요! 저희 숙소를 찾아주셔서 감사합니다. 편안한 휴식이 되시길 바랍니다.",
    amenities: [
    ...
    policies: [
      ...
      { title: "취소 규정", content: "체크인 3일 전: 전액 환불 | 체크인 1일 전: 50% 환불 | 당일: 환불 불가" },
      { title: "추가 안내", content: "반려동물 동반 불가 | 실내 흡연 금지 | 미성년자 단독 투숙 불가" },
    ],
    rooms: [
      {
        id: "room-1",
        ...
        keywords: ["커플추천", "가성비"],
        rentalPrice: 50000,
        rentalOriginalPrice: 60000,
        rentalTime: "최대 4시간",
        rentalAvailable: true,
        stayPrice: 150000,
        stayOriginalPrice: 190000,
        stayAvailable: true,
      },
      {
        id: "room-2",
      ...
      },
      {
        ...
        maxGuests: 4,
        amenities: ["Wi-Fi", "에어컨", "TV", "미니바", "욕조", "오션뷰", "라운지"],
        isAvailable: true,
        remainingCount: 1,
        keywords: ["오션뷰", "럭셔리", "가족"],
        rentalAvailable: false,
        stayPrice: 350000,
        stayOriginalPrice: 420000,
        stayAvailable: true,
      },
      {
        id: "room-4",
    ...
    reviews: {
      averageRating: 4.8,
      totalCount: 328,
      ratingDistribution: { 5: 210, 4: 78, 3: 25, 2: 10, 1: 5 },
    },
    bestReview: {
      id: "review-best",
      userName: "여행**",
      rating: 5,
      content: "뷰가 정말 환상적이었어요! 객실도 깔끔하고 직원분들도 너무 친절했습니다. 조식도 다양하고 맛있었어요. 다음에 또 방문하고 싶습니다.",
    ...
    recentReviews: [
      {
        ...
        userName: "힐링**",
        rating: 5,
        content: "위치가 너무 좋고, 주변에 볼거리도 많아요. 수영장에서 보는 석양이 정말 예뻤습니다.",
      ...
      },
      {
        ...
        userName: "가족**",
        rating: 4,
        content: "가족 여행으로 다녀왔어요. 아이들이 너무 좋아했습니다. 키즈존이 잘 되어있어서 좋았어요.",
        createdAt: "2026-03-05",
        roomName: "패밀리 룸",
      },
    ],
    events: [
      { id: "event-1", title: "봄맞이 특가 이벤트", description: "3월 한 달간 스위트룸 30% 할인", startDate: "2026-03-01", endDate: "2026-03-31" },
      { id: "event-2", title: "연박 할인", description: "2박 이상 시 추가 10% 할인", startDate: "2026-01-01", endDate: "2026-12-31" },
    ],
...
export function getAccommodationDetail(id: string): AccommodationDetail | null {
