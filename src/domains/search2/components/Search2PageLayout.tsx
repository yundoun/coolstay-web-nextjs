...
import { FilterSidebar } from "@/domains/search/components/FilterSidebar"
import { FilterBottomSheet } from "@/domains/search/components/FilterBottomSheet"
import { useSearch2Filters } from "../hooks"
import { search2MockData, totalSearchResults } from "../data/mock"
import { searchResultsData } from "@/domains/search/data/mock"
  ...
  return (
    <div className="min-h-screen">
      ...
      <Container size="wide" padding="responsive">
        {/* Lifestyle Filter Chips - Section spacing sm */}
        ...
        <div className="flex gap-6 lg:gap-8 pt-6">
          {/* Filter Sidebar - Desktop (280px from design system) */}
          <FilterSidebar
            filters={searchFilters}
            onToggleRegion={toggleRegion}
            onToggleType={toggleType}
          ...
          <div className="flex-1 min-w-0">
            {/* 기획전 Section - Design System Section Header */}
            ...
            {/* 추천 숙소 Section - Design System Section Header */}
...
// 사이드바가 있는 레이아웃용 그리드 (xl에서 3열)
function AccommodationGrid({ accommodations }: { accommodations: Accommodation[] }) {
